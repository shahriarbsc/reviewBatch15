...
public interface Drawable {
    ...
    public static final String TOOL = "Pencil"; //by default it is public static final variable
...
class Rectangle extends Shape implements Drawable {  // multiple inheritance
